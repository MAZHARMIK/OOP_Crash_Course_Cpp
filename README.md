...
<table id = "example" class="SectionTable display" >
		<tbody>
			...
			<tr>
        			<td>
					<a href="https://github.com/MAZHARMIK/OOP_Crash_Course_Cpp/blob/main/Static_Dynamic_Binding_V(Pure%20Virtual%20Function%20and%20Abstract%20Base%20Class).cpp">:flashlight:Static & Dynamic Binding-V(Pure Virtual Function & Abstract Class)</a>
				</td>
			</tr>
		</tbody>
</table>
